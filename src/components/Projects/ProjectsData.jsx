...
export const ProjectsData = [
    ...
    // Shertee project ...
    {
        ...
        description: "This project was prepared for Software engineering course, It's all about a clothes factory and how to prepare for projects works on agile process as an engineer.",
        date: "5-2-2022",
        button1Text: "See Doc",
        button2Text: "PPT",
    ...
    // Light-Up website project ...
    {
        ...
        description: "a small & simple light website built using (HTML, CSS & JS), In the future maybe I will improve it to do more functional things.",
        date: "15-9-2022",
        button1Text: "Github",
        button2Text: "Run",
    ...
    // Pure-JS cards design Project ...
    {
        ...
        description: "This project is the solution of Javascript challenge from Elzero Web School JS course which is have pure JS code.",
        date: "26-1-2023",
        button1Text: "Github",
        button2Text: "Run",
    ...
    // Front-End Tasks Part 2 project ...
    {
        ...
        description: "This section describes part 2 of Front-end Training, which it's a hover area with animation and a clock design implemented using (HTML + CSS).",
        date: "10-1-2023",
        button1Text: "Github",
        button2Text: "Run",
    ...
    // Front-End Tasks Part 3 project ...
    {
        ...
        description: "This section describes part 3 of Starting point Front-end Training Tasks, Which it's an animated emoji design.",
        date: "17-1-2023",
        button1Text: "Github",
        button2Text: "Run",
    ...
    // HTML CSS practice projects ...
    {
        ...
        description: "Which I had designed a templates using (HTML + CSS) after I had finished that courses from (Elzero web school) and You can find all of this in my Github profile.",
        date: "20-7-2022",
        button1Text: "Tmp-1",
        button2Text: "Tmp-2",
